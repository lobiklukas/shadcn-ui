// [FORCE-UI] Ember port of examples/base/combobox-basic.tsx. Ember composes
// the combobox from command + popover (documented framework pattern).
...
export default class ComboboxBasic extends Component {
  @tracked open = false;
  @tracked value = '';
