...
<ComponentPreview styleName="radix-force-ui" name="label-demo" />
...
```bash
npx shadcn@latest add @force-ui/label
```
...
<ComponentPreview styleName="radix-force-ui" name="label-rtl" direction="rtl" />
