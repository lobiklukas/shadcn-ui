...
// apps/v4/examples/base/chart-example-tooltip.tsx — grid + X axis +
// tooltip (no legend).
const CHART_DATA = [
...
@Component({
  selector: "preview-chart-example-tooltip",
  standalone: true,
...
export class ChartExampleTooltipComponent {
...
export default ChartExampleTooltipComponent
