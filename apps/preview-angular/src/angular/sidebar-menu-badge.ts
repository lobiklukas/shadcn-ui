...
@Component({
  selector: "preview-sidebar-menu-badge",
  standalone: true,
  imports: [
                ...
                <ul uiSidebarMenu>
                  @for (project of projects; track project.name) {
                    <li uiSidebarMenuItem>
                      ...
                      <div uiSidebarMenuBadge>{{ project.badge }}</div>
                    </li>
                  }
                </ul>
              </div>
...
export default class SidebarMenuBadgeDemoComponent {
  protected readonly projects = [
    { name: "Design Engineering", url: "#", icon: FRAME, badge: "24" },
    { name: "Sales & Marketing", url: "#", icon: PIE_CHART, badge: "12" },
    { name: "Travel", url: "#", icon: MAP, badge: "3" },
    { name: "Support", url: "#", icon: LIFE_BUOY, badge: "21" },
    { name: "Feedback", url: "#", icon: SEND, badge: "8" },
  ]
}
