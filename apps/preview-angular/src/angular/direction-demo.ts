...
@Component({
  selector: "preview-direction-readout",
  standalone: true,
...
@Component({
  selector: "preview-direction-demo",
  standalone: true,
  imports: [DirectionProvider, DirectionReadoutComponent],
  template: `
    <div
      uiDirectionProvider
      direction="ltr"
    ...
    >
      ...
      <div class="mt-2">
        <preview-direction-readout />
      </div>
    </div>
  `,
})
export class DirectionDemoComponent {}

export default DirectionDemoComponent
