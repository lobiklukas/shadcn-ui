...
@Component({
  selector: "preview-marker-rtl",
  standalone: true,
  imports: [Marker, MarkerContent, MarkerIcon],
  template: `
    <div dir="rtl" class="flex w-full flex-col gap-8 py-12 text-right sm:max-w-sm">
      <div uiMarker>
        ...
        <span uiMarkerContent>تم التبديل إلى فرع جديد</span>
      </div>
      <div uiMarker variant="separator">
        <span uiMarkerContent>اليوم</span>
      </div>
      <div uiMarker variant="border">
        ...
        <span uiMarkerContent>تم استكشاف ٤ ملفات</span>
      </div>
    </div>
  `
})
export class MarkerRtlComponent {}{}

export default MarkerRtlComponent
