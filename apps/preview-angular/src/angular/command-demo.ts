...
// Material Symbols (Rounded) inline SVGs — single swap point per demo.
...
@Component({
  ...
  template: `
    <div uiCommand class="max-w-sm rounded-lg border">
...
export class CommandDemoComponent {
  protected readonly calendar = CALENDAR_SVG
  protected readonly smile = SMILE_SVG
  protected readonly calculator = CALCULATOR_SVG
  protected readonly user = USER_SVG
  protected readonly creditCard = CREDIT_CARD_SVG
  protected readonly settings = SETTINGS_SVG
}
