...
import { DirectionProvider } from "@/angular-ui/direction"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
// apps/v4/examples/base/sidebar-rtl.tsx — the sidebar demo under forced RTL
// direction (DirectionProvider + dir="rtl", corner-placed trigger).
const svg = (d: string) =>
...
export default class SidebarRtlDemoComponent {
