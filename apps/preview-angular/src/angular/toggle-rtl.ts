...
@Component({
  selector: "preview-toggle-rtl",
  standalone: true,
  imports: [Toggle],
  template: ` <div dir="rtl" class="flex flex-wrap items-center gap-2">
    <button uiToggle aria-label="غامق">
      <svg
        aria-hidden="true"
    ...
    <button uiToggle variant="outline" aria-label="مائل">
      <svg
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 -960 960 960"
...
export class ToggleRtlComponent {}

export default ToggleRtlComponent
