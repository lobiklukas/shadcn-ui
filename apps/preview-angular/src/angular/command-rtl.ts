...
@Component({
  ...
  template: `
    <!-- Angular demos use static Arabic labels + dir="rtl" (no runtime
         translation helper); behaviour matches base's command-rtl. -->
    <div uiCommand dir="rtl" class="max-w-sm rounded-lg border">
      <div uiCommandInput aria-label="اكتب أمرًا أو ابحث..." placeholder="اكتب أمرًا أو ابحث..."></div>
      <div uiCommandList aria-label="اقتراحات">
        <div uiCommandEmpty>لم يتم العثور على نتائج.</div>
        <div uiCommandGroup heading="اقتراحات">
          <div uiCommandItem>
...
export class CommandRtlComponent {
...
export default CommandRtlComponent
