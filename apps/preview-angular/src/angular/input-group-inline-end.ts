...
@Component({
  selector: "preview-input-group-inline-end",
  standalone: true,
  ...
  template: `
    <div data-slot="field" role="group" class="max-w-sm flex w-full flex-col gap-2">
      <label uiLabel for="inline-end-input">Input</label>
      <div uiInputGroup>
        <input uiInputGroupInput id="inline-end-input" type="password" placeholder="Enter password" />
...
export class InputGroupInlineEndComponent {}

export default InputGroupInlineEndComponent
