...
import KeyboardCommandKey from '@material-symbols/svg-400/rounded/keyboard_command_key.svg?component'
...
import ContactSupport from '@material-symbols/svg-400/rounded/contact_support.svg?component'
import Send from '@material-symbols/svg-400/rounded/send.svg?component'
import DesignServices from '@material-symbols/svg-400/rounded/design_services.svg?component'
...
const data = {
  ...
  navSecondary: [
    { title: 'Support', url: '#', icon: ContactSupport as Component },
    { title: 'Feedback', url: '#', icon: Send as Component },
  ],
  projects: [
    { name: 'Design Engineering', url: '#', icon: DesignServices },
