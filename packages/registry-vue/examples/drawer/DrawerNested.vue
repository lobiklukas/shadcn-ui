  ...
  <Drawer>
    ...
    <DrawerContent>
      <DrawerHeader>
        ...
        <DrawerDescription>Drawers can be stacked on top of each other.</DrawerDescription>
      </DrawerHeader>
      <DrawerFooter>
        <Drawer v-model:open="innerOpen">
          <DrawerTrigger as-child>
            <Button>Open inner drawer</Button>
          </DrawerTrigger>
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle>Inner drawer</DrawerTitle>
              <DrawerDescription>This one sits on top.</DrawerDescription>
            </DrawerHeader>
            <DrawerFooter>
