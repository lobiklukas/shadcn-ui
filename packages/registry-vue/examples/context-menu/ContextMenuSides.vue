...
const zones = [
  ...
  { side: 'right', zone: 'col-start-3 col-span-1 row-start-2 row-span-2 items-center justify-end' },
  { side: 'bottom', zone: 'col-start-1 col-span-3 row-start-4 items-end' },
  { side: 'left', zone: 'col-start-1 col-span-1 row-start-2 row-span-2 items-center justify-start' },
] as const
</script>
...
<template>
  <div class="flex flex-col gap-2">
    ...
    <p class="text-xs text-muted-foreground">Last opened from the {{ side }} side.</p>
  </div>
</template>
